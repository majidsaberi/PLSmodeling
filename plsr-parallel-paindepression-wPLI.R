...
Connec =wPLI_Conn
YY=Pheno$Pain * Pheno$Depression
Z1=Pheno$Age
Z2=Pheno$Sex
...
PLSR_paindepression_wPLI_noagesex <- parLapply(cl = cl,1:7 , pls.modeling )

stopCluster(cl)

rm(list = ls()[ls() != "PLSR_paindepression_wPLI_noagesex"])
save.image("PLSR_paindepression_wPLI_noagesex.RData")

...
PLSR_painptsd_wPLI_noagesex <- parLapply(cl = cl,1:7 , pls.modeling )

stopCluster(cl)

rm(list = ls()[ls() != "PLSR_painptsd_wPLI_noagesex"])
save.image("PLSR_painptsd_wPLI_noagesex.RData")
